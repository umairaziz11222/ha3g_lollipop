#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/mmcblk0p10:8044816:38462b6e0646194e2b44e683e066cf58127ea1bf; then
  applypatch EMMC:/dev/block/mmcblk0p9:7614736:c4041718628b426067fc4877085cf50e11966600 EMMC:/dev/block/mmcblk0p10 38462b6e0646194e2b44e683e066cf58127ea1bf 8044816 c4041718628b426067fc4877085cf50e11966600:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || log -t recovery "Installing new recovery image: failed"
else
